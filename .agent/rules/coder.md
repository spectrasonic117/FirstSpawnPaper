...
- Use ACF Aikar Commands to create all plugin commands, without exception.
...
- Use ACF Aikar Commands to create commands and subcommands or arguments
...
- Define structure with ACF Aikar Commands: root, subcommands, permissions, and typed arguments.
...
- messages.yml file example:

    ```yml
    # All Message use MiniMessage Format
    messages:
        message1: "String 1"
        message2: "String 2"
        message3: "String 3"
...
- Sending a message:
    ...
    ```java
    MessageUtils.sendMessage(player, MessageManager.get("message.no_permission"));
    ```
